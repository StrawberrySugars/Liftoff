...
const initialFoods: Food[] = [
    {
        "name": "Garden Salad",
        "requiredPlants": ["Lettuce", "Tomato", "Carrot", "Basil", "Dill"],
    ...
    },
    {
        ...
        "requiredPlants": ["Sweet potato", "Chickpea", "Dill"],
    ...
    },
    {
        ...
        "requiredPlants": ["Soybean", "Tomato", "Basil"],
    ...
    {
        "name": "Herb Flatbread",
        "requiredPlants": ["Wheat", "Basil", "Dill"],
    ...
    {
        "name": "Chickpea Wraps",
        "requiredPlants": ["Lettuce", "Chickpea", "Carrot"],
